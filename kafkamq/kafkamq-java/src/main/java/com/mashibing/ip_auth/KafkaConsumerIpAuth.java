...
import com.mashibing.sasl.KafkaProducerAcl;
...
import static com.mashibing.base.BaseKafkaConstant.BOOT_SERVERS_IP_AUTH;
 ...
 * version: 1.0
 */
public class KafkaConsumerIpAuth {
    ...
    public void consumer0() {
        ...
        config.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,  BOOT_SERVERS_IP_AUTH);
        // 编解码
...
//        config.setProperty(ConsumerConfig.MAX_POLL_RECORDS_CONFIG,"");
        ...
        try (Consumer<String, String> consumer = new KafkaConsumer<String, String>(config);) {
            ...
            // 订阅topic
            consumer.subscribe(Collections.singletonList(KafkaProducerIpAuth.SIMPLE_TOPIC), new ConsumerRebalanceListener() {
                @Override
