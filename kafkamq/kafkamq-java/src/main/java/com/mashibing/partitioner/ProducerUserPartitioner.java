...
import com.mashibing.partitioner.impl.ValuePartitioner;
 ...
 * version: 1.0
 */
public class ProducerUserPartitioner extends BaseTest {

    private static final Logger logger = LoggerFactory.getLogger(ProducerUserPartitioner.class);

    public static final String USER_TOPIC = "user002";
