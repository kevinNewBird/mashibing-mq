...
import static com.mashibing.streams.timer.StreamTimeConsumer.WINDOW_TOPIC;
...
public class StreamTimeWindows {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KTable<Windowed<String>, Long> count = builder.stream(StreamProducer.PRODUCT_TOPIC) //从kafka中一条一条取数据
                ...
                //加5秒窗口,按步长2秒滑动  Hopping Time Window （滑动窗口）
